...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  // Grbl generic default settings. Should work across different machines.
  #define MICROSTEPS 4 // 16 --> all three jumpers installed
  #define STEPS_PER_REV 200.0
  #define MM_PER_REV 1.25 // 1.25 mm/rev leadscrew
  #define Cyclone_XY_Gear_Ratio 28/28 // Number of gear teeth (motor/rod)
  #define Cyclone_Z_Gear_Ratio 9/15 // Number of gear teeth (motor/rod)
  #define DEFAULT_X_STEPS_PER_MM 640//(STEPS_PER_REV*MICROSTEPS/(Cyclone_XY_Gear_Ratio*MM_PER_REV))
  #define DEFAULT_Y_STEPS_PER_MM 640//(STEPS_PER_REV*MICROSTEPS/(Cyclone_XY_Gear_Ratio*MM_PER_REV))
  #define DEFAULT_Z_STEPS_PER_MM 1066//(STEPS_PER_REV*MICROSTEPS/(Cyclone_Z_Gear_Ratio*MM_PER_REV))
